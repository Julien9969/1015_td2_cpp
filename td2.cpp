...
Film* lireFilm(istream& fichier, ListeFilms& listFilm)
{
	...
	for (int i = 0; i < film.acteurs.nElements; i++) {
		film.acteurs.elements[i] = lireActeur(fichier, listFilm); //TODO: Placer l'acteur au bon endroit dans les acteurs du film.
		ajoutFilmDansListe(film.acteurs.elements[i]->joueDans, &film); //TODO: Ajouter le film à la liste des films dans lesquels l'acteur joue.
	}
